...
def stitch_tile(path_to_file, xx, yy):
    ...
    offsetList = [[0] * 2 for _ in range(xx * xx)]
    with open(dir_name + '/' + "TileConfiguration.registered.txt") as f:
    ...
    new_image = Image.new(img_mode, (img_x + offsetList[xx - 1][0], img_y + offsetList[xx * xx - 1][1]))
    ...
    # end of stitching using overlap list
