...
if __name__ == '__main__':
  ...
  parser.add_argument('--input', type=str, default='E:/phase images',
      help='Image directory or movie file or "camera" (for webcam).')
  parser.add_argument('--weights_path', type=str, default='C:/Users/jackc/Downloads/SuperPointPretrainedNetwork/superpoint_v1.pth',
  ...
  parser.add_argument('--W', type=int, default=612,
